...
<@layout.emailLayout title=msg("eventUpdatePasswordSubject")>
  ...
  <@body.emailBody_en title=msg("eventUpdatePassword_title_en")>
    ...
    <@text.emailText>${msg("eventUpdatePassword_text1_en")?no_esc}</@text.emailText>
		<@text.emailText>${msg("eventUpdatePassword_text2_en")?no_esc} <@textLink.emailTextLink href=properties.ohcrnInfoEmail>${properties.ohcrnInfoEmail}</@textLink.emailTextLink> ${msg("eventUpdatePassword_text3_en")?no_esc}</@text.emailText>
  </@body.emailBody_en>
  ...
  <@body.emailBody_fr title=msg("eventUpdatePassword_title_fr")>
    ...
    <@text.emailText>${msg("eventUpdatePassword_text1_fr")?no_esc}</@text.emailText>
		<@text.emailText>${msg("eventUpdatePassword_text2_fr")?no_esc} <@textLink.emailTextLink href=properties.ohcrnInfoEmail>${properties.ohcrnInfoEmail}</@textLink.emailTextLink> ${msg("eventUpdatePassword_text3_fr")?no_esc}</@text.emailText>
  </@body.emailBody_fr>
</@layout.emailLayout>
