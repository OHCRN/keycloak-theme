...
<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false displaySmsInfo=true displayHelpFooterText=true>
    <!DOCTYPE html>
